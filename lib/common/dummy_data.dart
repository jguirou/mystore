  ...
  */
  ...
  static final List<ProductModel> products = [
    ProductModel(
      ...
      productVariations: [
        ProductVariationModel(
          id: '1',
          images: AppImages.productImage1,
          stock: 34,
          price: 134,
          salePrice: 122.6,
    ...
    ProductModel(
      ...
      description: 'This is a product desccription for leather brown jacket. There are things that can be added but i am just practicing and nothing else',
      brand: BrandModel(
        id: '6',
        name: 'ZARA',
        image: AppImages.zaraLogo,
